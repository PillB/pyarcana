...
- Current focus: **Section 2** (you will be told which one)
...
Begin by section 2,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `basics`
- Live URL to open: https://pillb.github.io/pyarcana/#`basics`  (or navigate to section 2 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s02-basics.ts`
- Section title (metadata only): Valores, tipos, operadores e I/O
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S02_EXPLORER_META.json`
