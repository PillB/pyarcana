...
- Current focus: **Section 16** (you will be told which one)
...
Begin by section 16,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `wxpython-gui`
- Live URL to open: https://pillb.github.io/pyarcana/#`wxpython-gui`  (or navigate to section 16 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s16-wxpython-gui.ts`
- Section title (metadata only): Calidad, limpieza y contratos de datos
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S16_EXPLORER_META.json`
