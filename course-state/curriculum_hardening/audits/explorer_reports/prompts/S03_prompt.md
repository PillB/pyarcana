...
- Current focus: **Section 3** (you will be told which one)
...
Begin by section 3,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `data-structures`
- Live URL to open: https://pillb.github.io/pyarcana/#`data-structures`  (or navigate to section 3 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s03-data-structures.ts`
- Section title (metadata only): Decisiones y reglas de validación
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S03_EXPLORER_META.json`
