...
- Current focus: **Section 48** (you will be told which one)
...
Begin by section 48,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `ai-governance`
- Live URL to open: https://pillb.github.io/pyarcana/#`ai-governance`  (or navigate to section 48 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s48-ai-governance.ts`
- Section title (metadata only): LLM applications y RAG con evidencia
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S48_EXPLORER_META.json`
