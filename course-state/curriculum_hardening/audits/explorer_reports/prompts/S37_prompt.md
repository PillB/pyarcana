...
- Current focus: **Section 37** (you will be told which one)
...
Begin by section 37,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `dbt-bigquery`
- Live URL to open: https://pillb.github.io/pyarcana/#`dbt-bigquery`  (or navigate to section 37 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s37-dbt-bigquery.ts`
- Section title (metadata only): Profiling, algoritmos y rendimiento
- Write the COMPLETE report (all 8 output sections + closing sentence) to this absolute path using the write tool:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S37_EXPLORER_REPORT.md`
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S37_EXPLORER_META.json`
