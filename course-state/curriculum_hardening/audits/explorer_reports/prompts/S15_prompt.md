...
- Current focus: **Section 15** (you will be told which one)
...
Begin by section 15,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `stdlib-deep`
- Live URL to open: https://pillb.github.io/pyarcana/#`stdlib-deep`  (or navigate to section 15 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s15-stdlib-deep.ts`
- Section title (metadata only): Pandas: ingesta, selección y tipos
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S15_EXPLORER_META.json`
