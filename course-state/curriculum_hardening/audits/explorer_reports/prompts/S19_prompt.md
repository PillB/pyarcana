...
- Current focus: **Section 19** (you will be told which one)
...
Begin by section 19,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `databases-orm`
- Live URL to open: https://pillb.github.io/pyarcana/#`databases-orm`  (or navigate to section 19 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s19-databases-orm.ts`
- Section title (metadata only): Visualización y comunicación accesible
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S19_EXPLORER_META.json`
