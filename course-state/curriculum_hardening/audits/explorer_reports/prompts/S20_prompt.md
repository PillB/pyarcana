...
- Current focus: **Section 20** (you will be told which one)
...
Begin by section 20,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `rag`
- Live URL to open: https://pillb.github.io/pyarcana/#`rag`  (or navigate to section 20 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s20-rag.ts`
- Section title (metadata only): Automatización robusta de Excel
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S20_EXPLORER_META.json`
