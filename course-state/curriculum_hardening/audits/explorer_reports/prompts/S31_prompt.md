...
- Current focus: **Section 31** (you will be told which one)
...
Begin by section 31,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `streaming-data`
- Live URL to open: https://pillb.github.io/pyarcana/#`streaming-data`  (or navigate to section 31 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s31-streaming-data.ts`
- Section title (metadata only): Grafos y evidencia relacional
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S31_EXPLORER_META.json`
