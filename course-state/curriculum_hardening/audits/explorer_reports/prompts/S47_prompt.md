...
- Current focus: **Section 47** (you will be told which one)
...
Begin by section 47,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `opensource`
- Live URL to open: https://pillb.github.io/pyarcana/#`opensource`  (or navigate to section 47 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s47-opensource.ts`
- Section title (metadata only): MLOps: experimentos, registro y serving
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S47_EXPLORER_META.json`
