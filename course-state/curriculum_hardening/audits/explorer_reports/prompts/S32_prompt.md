...
- Current focus: **Section 32** (you will be told which one)
...
Begin by section 32,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `microservices`
- Live URL to open: https://pillb.github.io/pyarcana/#`microservices`  (or navigate to section 32 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s32-microservices.ts`
- Section title (metadata only): Feature engineering y pipelines sin leakage
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S32_EXPLORER_META.json`
