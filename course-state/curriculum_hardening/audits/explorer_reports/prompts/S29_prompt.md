...
- Current focus: **Section 29** (you will be told which one)
...
Begin by section 29,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `mlops`
- Live URL to open: https://pillb.github.io/pyarcana/#`mlops`  (or navigate to section 29 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s29-mlops.ts`
- Section title (metadata only): SQL avanzado y modelado relacional
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S29_EXPLORER_META.json`
