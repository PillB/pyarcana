...
- Current focus: **Section 23** (you will be told which one)
...
Begin by section 23,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `computer-vision`
- Live URL to open: https://pillb.github.io/pyarcana/#`computer-vision`  (or navigate to section 23 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s23-computer-vision.ts`
- Section title (metadata only): Browser RPA con Playwright
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S23_EXPLORER_META.json`
