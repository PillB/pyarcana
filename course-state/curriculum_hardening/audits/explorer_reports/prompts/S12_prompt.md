...
- Current focus: **Section 12** (you will be told which one)
...
Begin by section 12,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `performance`
- Live URL to open: https://pillb.github.io/pyarcana/#`performance`  (or navigate to section 12 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s12-performance.ts`
- Section title (metadata only): APIs, SQL y geodatos responsables
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S12_EXPLORER_META.json`
