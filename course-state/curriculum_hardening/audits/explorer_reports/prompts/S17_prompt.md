...
- Current focus: **Section 17** (you will be told which one)
...
Begin by section 17,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `packaging`
- Live URL to open: https://pillb.github.io/pyarcana/#`packaging`  (or navigate to section 17 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s17-packaging.ts`
- Section title (metadata only): Joins, reshape, groupby y cierre analítico
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S17_EXPLORER_META.json`
