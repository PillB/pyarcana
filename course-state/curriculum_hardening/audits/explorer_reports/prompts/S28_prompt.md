...
- Current focus: **Section 28** (you will be told which one)
...
Begin by section 28,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `llm-agents`
- Live URL to open: https://pillb.github.io/pyarcana/#`llm-agents`  (or navigate to section 28 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s28-llm-agents.ts`
- Section title (metadata only): Pruebas de datos, propiedades e integración
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S28_EXPLORER_META.json`
