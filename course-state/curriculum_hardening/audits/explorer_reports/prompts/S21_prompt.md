...
- Current focus: **Section 21** (you will be told which one)
...
Begin by section 21,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `fastapi`
- Live URL to open: https://pillb.github.io/pyarcana/#`fastapi`  (or navigate to section 21 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s21-fastapi.ts`
- Section title (metadata only): Documentos, plantillas y reportes trazables
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S21_EXPLORER_META.json`
