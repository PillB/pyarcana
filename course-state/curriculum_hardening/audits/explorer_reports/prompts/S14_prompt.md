...
- Current focus: **Section 14** (you will be told which one)
...
Begin by section 14,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `security`
- Live URL to open: https://pillb.github.io/pyarcana/#`security`  (or navigate to section 14 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s14-security.ts`
- Section title (metadata only): NumPy y cómputo vectorizado
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S14_EXPLORER_META.json`
