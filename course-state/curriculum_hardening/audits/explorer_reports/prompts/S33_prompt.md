...
- Current focus: **Section 33** (you will be told which one)
...
Begin by section 33,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `advanced-models`
- Live URL to open: https://pillb.github.io/pyarcana/#`advanced-models`  (or navigate to section 33 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s33-advanced-models.ts`
- Section title (metadata only): ML supervisado y baselines responsables
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S33_EXPLORER_META.json`
