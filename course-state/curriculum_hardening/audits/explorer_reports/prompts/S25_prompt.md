...
- Current focus: **Section 25** (you will be told which one)
...
Begin by section 25,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `streamlit-dashboards`
- Live URL to open: https://pillb.github.io/pyarcana/#`streamlit-dashboards`  (or navigate to section 25 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s25-streamlit-dashboards.ts`
- Section title (metadata only): Endpoints de IA, Hugging Face y prompting evaluado
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S25_EXPLORER_META.json`
