...
- Current focus: **Section 36** (you will be told which one)
...
Begin by section 36,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `ai-apis-advanced`
- Live URL to open: https://pillb.github.io/pyarcana/#`ai-apis-advanced`  (or navigate to section 36 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s36-ai-apis-advanced.ts`
- Section title (metadata only): Clustering, anomalías y validación temporal
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S36_EXPLORER_META.json`
