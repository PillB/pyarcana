...
- Current focus: **Section 34** (you will be told which one)
...
Begin by section 34,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `cv-ai-integration`
- Live URL to open: https://pillb.github.io/pyarcana/#`cv-ai-integration`  (or navigate to section 34 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s34-cv-ai-integration.ts`
- Section title (metadata only): Métricas, desbalance, calibración y umbrales
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S34_EXPLORER_META.json`
