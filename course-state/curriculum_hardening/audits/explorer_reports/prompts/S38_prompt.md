...
- Current focus: **Section 38** (you will be told which one)
...
Begin by section 38,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `performance-extreme`
- Live URL to open: https://pillb.github.io/pyarcana/#`performance-extreme`  (or navigate to section 38 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s38-performance-extreme.ts`
- Section title (metadata only): Concurrencia, observabilidad y workflows resilientes
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S38_EXPLORER_META.json`
