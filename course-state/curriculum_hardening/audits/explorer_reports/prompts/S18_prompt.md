...
- Current focus: **Section 18** (you will be told which one)
...
Begin by section 18,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `data-engineering`
- Live URL to open: https://pillb.github.io/pyarcana/#`data-engineering`  (or navigate to section 18 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s18-data-engineering.ts`
- Section title (metadata only): EDA, estadística descriptiva e incertidumbre
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S18_EXPLORER_META.json`
