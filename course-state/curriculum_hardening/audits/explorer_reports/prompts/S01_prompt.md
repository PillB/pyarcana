...
- Current focus: **Section 1** (you will be told which one)
...
Begin by section 1,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `setup`
- Live URL to open: https://pillb.github.io/pyarcana/#`setup`  (or navigate to section 1 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s01-setup.ts`
- Section title (metadata only): Entorno reproducible y trabajo seguro
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S01_EXPLORER_META.json`
