...
- Current focus: **Section 49** (you will be told which one)
...
Begin by section 49,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `data-contracts`
- Live URL to open: https://pillb.github.io/pyarcana/#`data-contracts`  (or navigate to section 49 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s49-data-contracts.ts`
- Section title (metadata only): Agentes, herramientas y context engineering
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S49_EXPLORER_META.json`
