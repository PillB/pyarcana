...
- Current focus: **Section 13** (you will be told which one)
...
Begin by section 13,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `rpa-automation`
- Live URL to open: https://pillb.github.io/pyarcana/#`rpa-automation`  (or navigate to section 13 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s13-rpa-automation.ts`
- Section title (metadata only): Familiarity Evidence Dashboard y cierre de nivel
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S13_EXPLORER_META.json`
