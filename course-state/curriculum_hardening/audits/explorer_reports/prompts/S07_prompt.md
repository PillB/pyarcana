...
- Current focus: **Section 7** (you will be told which one)
...
Begin by section 7,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `data-acquisition`
- Live URL to open: https://pillb.github.io/pyarcana/#`data-acquisition`  (or navigate to section 7 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s07-data-acquisition.ts`
- Section title (metadata only): Texto, Unicode y expresiones regulares
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S07_EXPLORER_META.json`
