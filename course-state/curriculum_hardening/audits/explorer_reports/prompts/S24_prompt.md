...
- Current focus: **Section 24** (you will be told which one)
...
Begin by section 24,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `rpa-advanced`
- Live URL to open: https://pillb.github.io/pyarcana/#`rpa-advanced`  (or navigate to section 24 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s24-rpa-advanced.ts`
- Section title (metadata only): OCR y Document AI
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S24_EXPLORER_META.json`
