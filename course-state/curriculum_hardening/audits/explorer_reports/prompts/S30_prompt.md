...
- Current focus: **Section 30** (you will be told which one)
...
Begin by section 30,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `security-infra`
- Live URL to open: https://pillb.github.io/pyarcana/#`security-infra`  (or navigate to section 30 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s30-security-infra.ts`
- Section title (metadata only): Entity resolution probabilístico
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S30_EXPLORER_META.json`
