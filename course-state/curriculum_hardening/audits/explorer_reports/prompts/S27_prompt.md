...
- Current focus: **Section 27** (you will be told which one)
...
Begin by section 27,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `async-concurrency`
- Live URL to open: https://pillb.github.io/pyarcana/#`async-concurrency`  (or navigate to section 27 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s27-async-concurrency.ts`
- Section title (metadata only): Estrategia de pruebas con pytest
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S27_EXPLORER_META.json`
