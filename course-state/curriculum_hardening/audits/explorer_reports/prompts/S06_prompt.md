...
- Current focus: **Section 6** (you will be told which one)
...
Begin by section 6,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `numpy`
- Live URL to open: https://pillb.github.io/pyarcana/#`numpy`  (or navigate to section 6 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s06-numpy.ts`
- Section title (metadata only): Colecciones y estructuras de datos
