...
- Current focus: **Section 8** (you will be told which one)
...
Begin by section 8,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `pandas`
- Live URL to open: https://pillb.github.io/pyarcana/#`pandas`  (or navigate to section 8 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s08-pandas.ts`
- Section title (metadata only): Archivos, CSV, JSON y contratos de ingesta
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S08_EXPLORER_META.json`
