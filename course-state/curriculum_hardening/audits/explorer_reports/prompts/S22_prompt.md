...
- Current focus: **Section 22** (you will be told which one)
...
Begin by section 22,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `rapidfuzz-entity`
- Live URL to open: https://pillb.github.io/pyarcana/#`rapidfuzz-entity`  (or navigate to section 22 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s22-rapidfuzz-entity.ts`
- Section title (metadata only): Email, identidad y aprobación humana
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S22_EXPLORER_META.json`
