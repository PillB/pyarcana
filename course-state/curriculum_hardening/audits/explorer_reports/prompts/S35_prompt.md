...
- Current focus: **Section 35** (you will be told which one)
...
Begin by section 35,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `system-design`
- Live URL to open: https://pillb.github.io/pyarcana/#`system-design`  (or navigate to section 35 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s35-system-design.ts`
- Section title (metadata only): Explicabilidad, equidad e incertidumbre
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S35_EXPLORER_META.json`
