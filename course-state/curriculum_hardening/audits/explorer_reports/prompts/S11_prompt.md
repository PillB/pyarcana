...
- Current focus: **Section 11** (you will be told which one)
...
Begin by section 11,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `testing`
- Live URL to open: https://pillb.github.io/pyarcana/#`testing`  (or navigate to section 11 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s11-testing.ts`
- Section title (metadata only): OOP y modelo de dominio
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S11_EXPLORER_META.json`
