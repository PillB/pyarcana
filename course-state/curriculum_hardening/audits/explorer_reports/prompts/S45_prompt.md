...
- Current focus: **Section 45** (you will be told which one)
...
Begin by section 45,@Deep research  navigate the live page and repository source for that section only.

---
HARNESS DELIVERABLE (do not change analysis rules above):
- Platform section id (hash): `iac`
- Live URL to open: https://pillb.github.io/pyarcana/#`iac`  (or navigate to section 45 in the UI)
- Repo source file (workspace): `src/lib/course/sections/s45-iac.ts`
- Section title (metadata only): Cloud, almacenamiento, colas e infraestructura
...
- Also create a short JSON sidecar at:
  `/Users/pabloillescas/Projects/PyArcana/course-state/curriculum_hardening/audits/explorer_reports/S45_EXPLORER_META.json`
