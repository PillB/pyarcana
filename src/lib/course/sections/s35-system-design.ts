...
export const section35: CourseSection = {
  ...
  selfCheck: {
    questions: [
      {
        question: '¿Cuál es la diferencia entre arquitectura Lambda y Kappa?',
        options: [
          'Lambda tiene batch + speed layer; Kappa unifica todo en streaming — en 2025-2026 Kappa es preferida por menor complejidad',
          'Lambda es más moderna que Kappa',
          'Lambda usa Python; Kappa usa Java',
          'Son sinónimos',
        ],
        correctIndex: 0,
        explanation: 'Lambda combina batch (procesa histórico) + speed (streaming). Kappa elimina el batch layer: todo es streaming, y para reprocesar histórico se replay el Kafka topic. Kappa reduce complejidad — un solo código base.',
      },
      {
        question: '¿Qué es un feature store y por qué importa?',
        options: [
          'Centraliza features para que sean consistentes entre training e inference — sin feature store, tienes training-serving skew',
          'Un almacén de datasets de entrenamiento',
          'Un sistema de control de versiones para features',
          'Una tienda de modelos pre-entrenados',
        ],
        correctIndex: 0,
        explanation: 'Un feature store (Feast, Tecton) asegura que las features calculadas en training sean las mismas que en inference. Sin esto, el modelo se entrena con features calculadas de una forma pero en producción se calculan diferente — skew.',
      },
      {
        question: '¿Qué es un ADR (Architecture Decision Record)?',
        options: [
          'Documento que registra decisiones técnicas: contexto, decisión, alternativas, consecuencias — vital para equipos que escalan',
          'Un sistema de control de access',
          'Un tipo de base de datos',
          'Un framework de testing',
        ],
        correctIndex: 0,
        explanation: 'Un ADR documenta por qué elegiste Kafka sobre RabbitMQ, por qué PostgreSQL sobre MongoDB. Cuando un nuevo engineer pregunta "¿por qué?", el ADR responde. Se guarda en /docs/adr/ dentro del repo.',
      },
      {
        question: 'Batch vs real-time inference?',
        options: [
          'Batch: procesa N registros en bloque (más barato, latencia minutos/horas). Real-time: predice por request en <100ms (más caro, latencia inmediata)',
          'Batch es siempre mejor',
          'Real-time es siempre mejor',
          'No hay diferencia práctica',
        ],
        correctIndex: 0,
        explanation: 'Batch: proceso 1M registros cada noche, costo $5. Real-time: predicción por request en <100ms, costo $500/día. Scoring crediticio puede ser batch; detección de fraude debe ser real-time.',
      },
      {
        question: '¿Qué es KEDA y para qué sirve?',
        options: [
          'Event-driven autoscaling para Kubernetes — escala a 0 pods cuando no hay tráfico y sube según la cola de eventos (Kafka, Redis, SQS)',
          'KEDA es un orquestador como Kubernetes',
          'KEDA es un sistema de monitoreo',
          'KEDA es un load balancer',
        ],
        correctIndex: 0,
        explanation: 'KEDA (Kubernetes Event-Driven Autoscaling) escala pods basándose en métricas externas: si hay 1000 mensajes en Kafka, sube a 10 pods; si hay 0, escala a 0. Ahorra 80% en workloads con tráfico variable.',
      },
    ],
  },
  resources: {
