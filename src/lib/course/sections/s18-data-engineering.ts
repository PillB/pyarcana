...
export const section18: CourseSection = {
  ...
  selfCheck: {
    questions: [
      {
        question: '¿Cuál de los siguientes describe mejor: Construir pipelines ETL/ELT con prefect 3.x: @flow, @task, retries, deployments?',
        options: [
          'Respuesta correcta',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Trabajar con Parquet usando pyarrow: lectura/escritura, partitioning por fecha, schema enforcement?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Implementar idempotencia en pipelines: qué es, por qué importa, cómo garantizarla?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Usar great_expectations para validar calidad de datos con Expectation Suites?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Gestionar configuración de pipelines con Pydantic Settings y variables de entorno?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
