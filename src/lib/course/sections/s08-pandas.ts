  ...
  theory: [
    {
     ...
     },
     {
      ...
      paragraphs: [
        ...
        "**Ritmo orientativo (unas 9 horas).** De esas, tres para el núcleo: al terminarlo ya tienes leer un CSV ajeno sin que el encoding ni las filas irregulares te sorprendan. El resto se va en la práctica guiada, el proyecto del bloque y el autochequeo. No hace falta hacerlo de una sentada.",
