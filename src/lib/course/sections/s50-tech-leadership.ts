...
export const section50: CourseSection = {
  ...
  jobRelevance:
    "En equipos de plataforma y producto, las evals (baterías de pruebas repetibles), el red teaming (ataques internos controlados) y la fiabilidad de IA demuestran que un copiloto agentic o RAG no solo «funciona en demo»: exige holdouts (datos reservados), acuerdo humano-LLM, inyección bloqueada y SLO de p95 (objetivo de latencia en el percentil 95). Aquí aprendes a cubrir los slices (segmentos de tareas por tipo) reales, bloquear inyección y exfiltración, y a abstenerse o escalar a humano cuando un claim crítico no tiene soporte. El liderazgo técnico aquí es evidencia medible, no solo soft skills.",
  learningOutcomes: [
