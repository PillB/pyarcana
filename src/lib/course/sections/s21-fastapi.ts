...
export const section21: CourseSection = {
  ...
  selfCheck: {
    questions: [
      {
        question: '¿Cuál de los siguientes describe mejor: Construir APIs REST con FastAPI: path params, query params, request bodies con Pydantic v2?',
        options: [
          'Respuesta correcta',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Implementar autenticación JWT con OAuth2 Password Flow y python-jose?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Crear endpoints WebSocket para streaming de datos en tiempo real?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Usar BackgroundTasks para tareas asíncronas que no bloquean la respuesta?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Implementar middleware: CORS, logging estructurado, rate limiting con slowapi?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
