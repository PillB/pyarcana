...
export const section29: CourseSection = {
  ...
  selfCheck: {
    questions: [
      {
        question: '¿Qué es MLflow y cuáles son sus componentes?',
        options: [
          'Tracking (experimentos), Model Registry (versionado), Projects (reproducibilidad), Models (deployment) — plataforma open-source para gestionar el ciclo de vida de ML',
          'Un framework de deep learning',
          'Un sistema de control de versiones para datos',
          'Una librería de visualización',
        ],
        correctIndex: 0,
        explanation: 'MLflow gestiona todo el ciclo de vida: Tracking registra params/metrics, Model Registry versiona modelos, Projects empaqueta código, Models sirve modelos como API.',
      },
      {
        question: '¿Qué es data drift?',
        options: [
          'Cuando la distribución de los datos en producción cambia respecto a los de entrenamiento — se detecta con tests estadísticos (KS test, PSI) usando Evidently o Alibi Detect',
          'Cuando los datos se corrompen en la DB',
          'Cuando el modelo se vuelve más lento',
          'Cuando los datos se mueven entre servidores',
        ],
        correctIndex: 0,
        explanation: 'Data drift: los datos de producción ya no se ven como los de entrenamiento. Síntomas: accuracy cae. Se detecta comparando distribuciones estadísticamente.',
      },
      {
        question: '¿Qué es DVC (Data Version Control)?',
        options: [
          'Versiona datasets y modelos grandes que Git no puede manejar — usa el mismo workflow de Git pero almacena archivos en storage externo (S3, GCS)',
          'DVC es un reemplazo de Git',
          'DVC es un sistema de colas',
          'DVC es un visor de diff',
        ],
        correctIndex: 0,
        explanation: 'DVC versiona archivos grandes: el archivo .dvc (metadata) va en Git, los datos van a S3/GCS. Permite reproducir experimentos con datos exactos.',
      },
      {
        question: '¿Qué es concept drift vs data drift?',
        options: [
          'Concept drift: la relación features-target cambia; data drift: solo cambian las distribuciones de features',
          'Son sinónimos',
          'Concept drift es para deep learning; data drift para ML tradicional',
          'Concept drift mejora el modelo; data drift lo empeora',
        ],
        correctIndex: 0,
        explanation: 'Data drift: P(X) cambia. Concept drift: P(Y|X) cambia — la relación entre features y target se altera. Ej: COVID cambió patrones de consumo. Concept drift requiere reentrenar.',
      },
      {
        question: '¿Qué es un model registry?',
        options: [
          'Sistema que versiona modelos con estados (Staging/Production/Archived), permitiendo rollback y auditoría de qué modelo está en producción',
          'Un registro de marcas de modelos',
          'Un catálogo de modelos pre-entrenados',
          'Una base de datos de hiperparámetros',
        ],
        correctIndex: 0,
        explanation: 'Un model registry versiona modelos: v1.0 (Archived), v2.0 (Production). Permite rollback, A/B testing, auditoría de qué modelo sirvió cada predicción.',
      },
    ],
  },
  resources: {
