...
export const section16: CourseSection = {
  ...
  selfCheck: {
    questions: [
      {
        question: '¿Cuál de los siguientes describe mejor: Crear ventanas con wx.Frame, wx.Panel y layouts con wx.BoxSizer, wx.GridSizer?',
        options: [
          'Respuesta correcta',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Manejar eventos: EVT_BUTTON, EVT_CLOSE, EVT_TIMER, EVT_TEXT, key/char events?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Usar widgets clave: wx.TextCtrl, wx.ComboBox, wx.ListCtrl, wx.Grid, wx.Notebook?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Implementar threading seguro con wx.CallAfter y wx.PostEvent?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
      ...
      {
        question: '¿Cuál de los siguientes describe mejor: Usar pubsub y PyDispatcher para comunicación desacoplada entre componentes (Recipes 7-8)?',
        options: [
          'Respuesta correcta',
          'Respuesta incorrecta 1',
          'Respuesta incorrecta 2',
