    ...
    steps: [
      {
        ...
        kind: "apply",
        instruction:
          "Imprime unit, target needs_review_7d y horizon 7. Imprime exactamente las líneas de la solución de referencia.",
...
horizon 7`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Prevalencia de y=[0,1,0,0]. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
pos 1`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Valida target name no contiene 'fraud'. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
policy review_not_fraud`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Dummy majority para y=[1,1,0]. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
n 3`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Regla x>=1 predice 1; accuracy vs y. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
keep_rule True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Costo total: fp*1 + fn*5 con fp=2,fn=1. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
fn 1`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "sigmoid(0) y sigmoid(2) redondeados 3 dec. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Predicción w=1,b=0,x=0.2 umbral 0.5. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
thr 0.5`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "L2 penalty w^2 para w=[1,2]. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Ordena coefs por |w| desc e imprime nombres. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
causal False`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Marca si features están scaled (flag True). Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Signo de coef shared_phone=0.8. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
causal False`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Stump thr=0.3 sobre X=[0.1,0.4]. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Voto mayoría de 3 stumps preds. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Compara stump acc vs majority dummy. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "best depth by valid list. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
seed 7`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Detect overfit if train-valid gap>0.2. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Fija seed e imprime random 3 ints 0-9. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
repro True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "JSON metrics keys sorted. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
run r1`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Lista campos mínimos de run. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "beats_dummy check. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
dummy 0.5`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Mean de folds. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Slice con más FN. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
...
ok True`,
      ...
      },
      {
        ...
        kind: "apply",
        instruction:
          "Group CV: n groups = n unique entities. Imprime exactamente las líneas de la solución de referencia.",
        hint: "Sigue el framing del subtema.",
        hints: [
          "Sigue el framing del subtema.",
          "Tres prints finales.",
    ...
    questions: [
      {
        ...
        options: [
          "fraud_auto",
          "needs_review u objetivo de cola",
          "parentesco",
          "culpa",
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          "Despliega igual",
          "Conserva regla y no vendas humo",
          "Borra baseline",
          "Sube depth a 100",
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          "Causalidad de fraude",
          "Asociación en el modelo, no causa legal",
          "Parentesco",
          "Que el grafo miente",
        ],
        correctIndex: 1,
