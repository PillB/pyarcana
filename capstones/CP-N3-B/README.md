...
**Level 3 · Gate S34 · Version 1.2.0**

Evidence graph, bounded path search, authorisation filter, direct/inferred, uncertainty, notes, correction, reproducibility. Every edge answers 6 questions.
