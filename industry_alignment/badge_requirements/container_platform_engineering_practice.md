# Badge Requirements — Container Platform Engineering Practice

**Badge ID:** `container_platform_engineering_practice`  
**Version:** 1.0.0  
...
> The learner has independently demonstrated container-platform engineering practice — Docker, Kubernetes, CI/CD, cloud platforms, and GPU performance tuning — through You Do projects and section exams above the provisional floor.
...
- `BADGE:container_platform_engineering_practice:integrator`
...
`BADGE:container_platform_engineering_practice:integrator`. The learner must:

1. Hold every prerequisite badge
   (`production_python_delivery_foundations`, `production_python_hardening_practice`).
...
3. Complete a bounded independent exercise that ties together
   ...
   specification is in `badge_rubrics/container_platform_engineering_practice.json#integrator_spec`.
