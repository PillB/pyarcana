# Badge Requirements — AI Governance and Code Review Practice

**Badge ID:** `ai_governance_code_review_practice`  
**Version:** 1.0.0  
...
> The learner has independently demonstrated AI-governance and code-review practice — open-source contribution, AI code-review literacy, AI governance, data-contract design, stakeholder translation — through You Do projects and section exams above the provisional floor.
...
- `BADGE:ai_governance_code_review_practice:integrator`
...
`BADGE:ai_governance_code_review_practice:integrator`. The learner must:

1. Hold every prerequisite badge
   (`architecture_decision_practice`, `container_platform_engineering_practice`).
...
3. Complete a bounded independent exercise that ties together
   ...
   specification is in `badge_rubrics/ai_governance_code_review_practice.json#integrator_spec`.
