# Badge Requirements — Production Python Delivery Foundations

**Badge ID:** `production_python_delivery_foundations`  
**Version:** 1.0.0  
...
> The learner has independently demonstrated production-ready Python delivery foundations — packaging, CI/CD, FastAPI service design, and a working test discipline — through You Do projects and section exams above the provisional floor.
...
- `BADGE:production_python_delivery_foundations:integrator`
...
`BADGE:production_python_delivery_foundations:integrator`. The learner must:
...
3. Complete a bounded independent exercise that ties together
   ...
   specification is in `badge_rubrics/production_python_delivery_foundations.json#integrator_spec`.
