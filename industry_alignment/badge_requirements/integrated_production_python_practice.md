# Badge Requirements — Integrated Production Python Practice

**Badge ID:** `integrated_production_python_practice`  
**Version:** 1.0.0  
...
`S15`, `S17`, `S21`, `S27`, `S28`, `S30`, `S32`, `S38`
...
- `BADGE:integrated_production_python_practice:integrator`
...
badge is `BADGE:integrated_production_python_practice:integrator`. The learner must:

1. Hold every prerequisite applied-skill badge
   (`python_data_foundations`, `production_python_delivery_foundations`, `reliable_async_python_development`, `production_python_hardening_practice`).
...
4. Submit to a server-side rubric evaluation per
   `badge_rubrics/integrated_production_python_practice.json#integrator_rubric`.
