# Badge Requirements — Applied RAG and LLM Service Development

**Badge ID:** `applied_rag_llm_service_development`  
**Version:** 1.0.0  
...
> The learner has independently demonstrated applied RAG and LLM service development — building a Retrieval-Augmented Generation pipeline, exposing it as a tested FastAPI service, and documenting design tradeoffs — through You Do projects and section exams above the provisional floor.
...
- `BADGE:applied_rag_llm_service_development:integrator`
...
`BADGE:applied_rag_llm_service_development:integrator`. The learner must:
...
3. Complete a bounded independent exercise that ties together
   ...
   specification is in `badge_rubrics/applied_rag_llm_service_development.json#integrator_spec`.
