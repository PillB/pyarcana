...
const QUESTION_BANK: Record<string, Q[]> = {
  ...
  'streaming-data': [
    {
      ...
      options: [
        ...
        'Un proceso de batch sin identidad',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Es lo mismo que un índice de base de datos',
      ],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'Borra el multigrafo',
        'El store solo acepta aristas dirigidas',
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'Materializar hechos de vinculación con evidencia',
        'Entrenar un modelo de marketing',
      ],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: [
        'Nodo sin aristas',
        'Un hiperparámetro de un clasificador',
        'Un secreto de infraestructura',
    ...
    {
      concept: 'dedup-agg-keep-detail',
      question: 'La clave de agregación entre el mismo par debe incluir al menos:',
      options: [
        'Solo el color del nodo',
        'src, dst y etype (y unidad/ventana si aplica)',
        'Únicamente el apellido del cliente',
        'Un label de parentesco',
      ],
      correctIndex: 1,
      explanation: 'Sin etype, transfer y shared_phone del mismo par se colapsan de forma incorrecta.',
    },
    {
      concept: 'dedup-agg-keep-detail',
      ...
      options: [
        ...
        'Cumples siempre privacidad automáticamente',
    ...
    {
      concept: 'degree-components-paths',
      question: 'Degree centrality en un grafo simple no dirigido (definición estándar / NetworkX) es:',
      options: [
        'deg(v) / (n − 1)',
        'deg(v) / max_deg del grafo (si max_deg ≠ n−1, no es la definición canónica)',
        'Siempre 1.0 para todos los nodos',
        'El número de componentes conexas',
      ],
      correctIndex: 0,
      explanation: 'NetworkX: degree_centrality(v) = deg(v)/(n-1). Normalizar por el máximo observado es otra métrica.',
    },
    {
      concept: 'degree-components-paths',
      ...
      correctIndex: 2,
      explanation: 'Camino = traza auditable; no implica culpabilidad.',
    },
    {
    ...
    {
      concept: 'centrality-limited-interp',
      question: 'Interpretar betweenness o closeness sin límites es riesgoso porque:',
      options: [
        'Siempre es 0',
    ...
    {
      concept: 'subgraphs-tests',
      question: 'Un builder idempotente de aristas dirigidas debe:',
      options: [
        'Ordenar cada arista con sorted(u,v) y colapsar A→B con B→A',
        'Conservar el par ordenado (src, dst) y producir el mismo conjunto ordenado en re-runs',
        'Ignorar etype y provenance',
        'Asignar labels de fraude al azar',
      ],
      correctIndex: 1,
      explanation: 'Idempotencia ≠ borrar dirección. A→B y B→A son hechos distintos.',
    },
    {
      ...
      options: [
        ...
        'Usar solo capturas sin leyenda',
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation: 'Drill-down a la arista auditable.',
    },
    {
      concept: 'viz-scale-privacy-edge-evidence',
  ...
  'system-design': [
    {
      ...
      options: [
        ...
        'Causalidad legal del comportamiento de una persona',
        'Que el top_feature implica etiqueta de fraude',
        'La prevalencia exacta de fraude en producción',
      ],
      correctIndex: 0,
      explanation: 'Perm importance = dependencia predictiva bajo una métrica, no culpa ni fraude.',
    },
    {
      concept: 'coefs-perm-importance',
      ...
      options: [
        ...
        'Fraude demostrado en el caso',
        'Escala de la feature, correlación y el objetivo de optimización',
        'Solo overfitting de árboles de decisión',
      ],
      correctIndex: 2,
      explanation: 'Interpreta coeficientes con scaling, colinealidad y límites del modelo.',
    },
    {
      concept: 'coefs-perm-importance',
      question: 'Comparar importancias entre modelos distintos sin la misma métrica/split es:',
      options: [
        'Siempre válido si el accuracy global es alto',
        'Obligatorio en cualquier auditoría legal',
        'Equivalente a una cobertura conformal',
        'Engañoso; alinea primero el protocolo de evaluación',
      ],
      correctIndex: 3,
      explanation: 'Sin protocolo comparable, el ranking de importancia no es interpretable entre modelos.',
    },
    {
      ...
      options: [
        ...
        'Publicar PII del caso para «transparencia»',
        'Reemplazar el proceso de apelación humana',
      ],
      correctIndex: 1,
      explanation: 'Local ≠ causal global; la ficha separa modelo y decisión humana.',
    },
    {
      concept: 'local-corr-limits',
      ...
      options: [
        ...
        'No afectan al modelo en absoluto',
        'Eliminan el desbalance de clases',
        'Garantizan fairness entre cohortes',
      ],
      correctIndex: 0,
      explanation: 'Correlación confunde la atribución de importancia entre features.',
    },
    {
      concept: 'local-corr-limits',
      ...
      options: [
        ...
        'Ocultar el model card para proteger al equipo',
        'Apoyar revisión humana sin convertir score en veredicto de fraude',
        'Prohibir cualquier override del analista',
      ],
      correctIndex: 2,
      explanation: 'Explicar ≠ condena. Scores ≠ fraude.',
    },
    {
      concept: 'cohorts-slice-metrics',
      question: 'Métricas por cohorte/slice evalúan:',
      options: [
        'Solo el promedio global del modelo',
        'Únicamente el Brier score agregado',
        'Desempeño en subgrupos definidos (fuente, segmento, tiempo)',
        'La estética de la UI de la cola',
      ],
      correctIndex: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'El número de GPUs del cluster de training',
        'Un random seed oculto al equipo de riesgo',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        'Aceptable sin notas si AUC global > 0.9',
        'Prueba de parentesco entre entidades',
        'Irrelevante mientras el score puntual sea alto',
        'Señal de riesgo de daño diferencial / fallo operacional',
      ],
      correctIndex: 3,
      explanation: 'Equidad y operación miran colas y grupos, no solo el promedio.',
    },
    {
      ...
      options: [
        ...
        'Es siempre el target de entrenamiento',
        'Correlaciona o codifica indirectamente atributos sensibles',
        'Solo existe en grafos de conocimiento',
      ],
      correctIndex: 2,
      explanation: 'Proxies pueden reintroducir discriminación de forma indirecta.',
    },
    {
      concept: 'proxies-sample-harm',
      question: 'Sample size pequeño en un slice implica:',
      options: [
        'Métricas muy confiables por definición',
        'Intervalos amplios e interpretaciones cautelosas',
        'Que el slice debe ignorarse siempre sin documentar',
        'Calibración perfecta del score',
      ],
      correctIndex: 1,
      explanation: 'n chico → incertidumbre alta; no afirma paridad ni inequidad.',
    },
    {
      concept: 'proxies-sample-harm',
      ...
      options: [
        ...
        'El modelo es un dummy classifier',
        'No hay scores en la cola de revisión',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        ...
        'Maximizar solo accuracy sin mirar probabilidades',
        'Eliminar el human review de la cola',
        'Probar colusión entre entidades',
      ],
      correctIndex: 0,
      explanation: 'Probabilidades confiables para decisiones y umbrales.',
    },
    {
      concept: 'cal-intervals-conformal',
      question: 'Conformal prediction (concepto) aporta:',
      options: [
        'Un reemplazo de todos los modelos de scoring',
        'Labels automáticos de parentesco',
        'Garantías de cobertura de conjuntos de predicción bajo supuestos',
        'Un optimizador de consultas SQL',
      ],
      correctIndex: 2,
      explanation: 'Cobertura finita-sample bajo supuestos; no es un modelo sustituto.',
    },
    {
      concept: 'cal-intervals-conformal',
      question: 'Intervalos de incertidumbre se usan para:',
      options: [
        'Forzar siempre una decisión binaria sin revisión',
        'Borrar el model card cuando el score es alto',
        'Ocultar errores de slice con un solo número',
        'Comunicar duda y disparar abstención o revisión humana',
      ],
      correctIndex: 3,
      explanation: 'Incertidumbre → control humano; la banda toy del lab no afirma cobertura real.',
    },
    {
      ...
      options: [
        ...
        'Siempre un falso positivo de fraude',
        'Un índice de base de datos mal formado',
      ],
      correctIndex: 1,
      explanation: 'OOD = fuera del soporte visto en train (o de la referencia declarada).',
    },
    {
      concept: 'ood-abstention',
      ...
      options: [
        ...
        'Borrar logs para no dejar rastro del fallo',
    ...
    },
    {
      ...
      options: [
        ...
        'Solo el nombre del archivo de entrada',
        'El color del botón de la UI de cola',
        'El número de licencias de software del servidor',
      ],
      correctIndex: 0,
      explanation: 'Señales de novedad + política de abstención; el lab usa una heurística univariante.',
    },
    {
      ...
      options: [
        ...
        'Contraseñas de despliegue del servicio',
        'PII de evaluación real de clientes',
        'Propósito, datos, métricas, límites, riesgos y uso previsto',
      ],
      correctIndex: 3,
      explanation: 'Transparencia operativa y ética del modelo.',
    },
    {
      concept: 'model-card-contestability',
      ...
      options: [
        ...
        'Que existe vía para impugnar o revisar decisiones automatizadas',
        'Que el modelo no tiene umbral',
        'Que se prohíbe el override humano',
      ],
      correctIndex: 1,
      explanation: 'Derecho o proceso a cuestionar decisiones automatizadas.',
    },
    {
      concept: 'model-card-contestability',
      question: 'Sin límites de uso en el model card, el riesgo es:',
      options: [
        'Over-documentación inofensiva',
        'Mejor calibración automática',
        'Uso fuera de alcance (p. ej. tratar score como prueba legal de fraude)',
        'Menos necesidad de slices por cohorte',
      ],
      correctIndex: 2,
      explanation: 'Scope misuse es un riesgo central de gobernanza.',
    },
    {
      concept: 'approve-override-appeal-retire',
      question: 'Aprobación humana (human approval) en el flujo implica:',
      options: [
        'Que el modelo publica solo a redes sociales',
        'Que no hace falta dejar logs de la decisión',
        'Que el score es ley y no se puede impugnar',
        'Un actor autorizado confirma o alza la acción antes o después del score',
      ],
      correctIndex: 3,
      explanation: 'Human control point con responsabilidad explícita.',
    },
    {
      concept: 'approve-override-appeal-retire',
      question: 'Override documentado debe registrar:',
      options: [
        'Nada, para ir más rápido en la cola',
        'Solo un emoji del analista en el chat',
        'Quién, cuándo, por qué y el estado previo del sistema',
        'PII innecesaria extra de terceros',
      ],
      correctIndex: 2,
      explanation: 'Auditoría del override: actor, tiempo, razón y estado.',
    },
    {
      concept: 'approve-override-appeal-retire',
      ...
      options: [
        ...
        'El model card es demasiado largo',
        'El accuracy de train bajó 0.001% un día',
        'Un usuario pidió un color nuevo en la UI',
      ],
      correctIndex: 0,
      explanation: 'Retiro = control de riesgo. Scores retirados no “prueban” fraude histórico sin contexto.',
    },
  ],
  ...
  'agentic-architecture': [
    ...
    },
    {
      ...
      correctIndex: 3,
      explanation: "Latencia, precisión y auditabilidad son QA; branding no.",
    },
    {
    ...
    },
    {
      ...
      correctIndex: 2,
      explanation: "Recall de candidatos frente a costo es un trade-off clásico. Matching no prueba parentesco.",
    },
    {
      concept: "cohesion-coupling-layers",
      question: "Alta cohesión en un módulo de triage significa:",
      options: [
        "Depende de todos los servicios externos",
        "Comparte tablas de base de datos con reporting sin contrato",
    ...
    {
      concept: "cohesion-coupling-layers",
      question: "Bajo acoplamiento entre capas se logra típicamente:",
      options: [
    ...
    },
    {
      ...
      options: [
        "Un modelo y lenguaje ubicuo con límites de consistencia y ownership",
        "Solo la VPC de AWS",
        "El color del logo",
        "La versión de Python",
      ],
    ...
    },
    {
      ...
      correctIndex: 2,
      explanation: "Mismo término, distintos BC: no forzar un solo modelo; declara el mapa y el ACL.",
    },
    {
      concept: "bounded-contexts-ubiquitous",
    ...
    },
    {
      ...
      correctIndex: 0,
      explanation: "VO: igualdad estructural; en producción suele ser inmutable.",
    },
    {
      concept: "entities-vo-services",
    ...
    },
    {
      ...
      options: [
        "Muestra secuencia y responsables del proceso además de la estructura estática",
        "Reemplaza tests",
        "Prueba colusión entre empresas",
        "Elimina la necesidad de contratos",
      ],
      correctIndex: 0,
      explanation: "Estructura (C4) y flujo (proceso) son vistas distintas.",
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "Se esconde en un TODO eterno sin dueño",
        "Se usa para justificar fraude",
        "Se prioriza con costo/riesgo y plan de pago",
      ],
      correctIndex: 3,
      explanation: "Deuda se gestiona con dueño y plan, no se mitifica.",
    },
    {
      concept: "apis-events-debt-compat",
  ...
  // correctIndex distribution rebalanced 6/6/6/6 (was 0/24/0/0 — always B)
  'data-contracts': [
    {
      ...
      correctIndex: 0,
      explanation: "Prefiere workflow cuando el procedimiento es conocido y debe ser determinista.",
    },
    {
      concept: "workflow-vs-agent",
      ...
      correctIndex: 1,
      explanation: "El agente cabe cuando hay incertidumbre y tool-use dinámico bajo políticas (plan, budget, evaluator).",
    },
    {
      concept: "workflow-vs-agent",
      ...
      correctIndex: 2,
      explanation: "Promover un agente sin ganancia medida sube costo y no-determinismo.",
    },
    {
      ...
      options: [
        ...
        "El learning rate",
        "La VPC",
        "Qué skill o flujo invocar según la petición",
      ],
      correctIndex: 3,
      explanation: "El router elige la ruta (skill/flujo) según la petición.",
    },
    {
      concept: "routing-planner-evaluator",
      question: "Planner + executor separa:",
      options: [
        "Decidir el plan frente a ejecutar pasos o herramientas",
        "UI y CSS solo",
        "Authn y authz de forma incorrecta a propósito",
        "Train y serve de embeddings",
      ],
      correctIndex: 0,
      explanation: "El planner decide; el worker/executor ejecuta tools.",
    },
    {
      concept: "routing-planner-evaluator",
      ...
      options: [
        "Solo el DNS",
        "Calidad y seguridad de la salida antes de entregarla",
        "El semver del kernel",
        "La factura de la nube sin datos",
      ],
      correctIndex: 1,
      explanation: "El evaluator cierra el loop: calidad/seguridad antes de entregar.",
    },
    {
      ...
      correctIndex: 2,
      explanation: "Tools SRP se autorizan, testean y componen con least privilege.",
    },
    {
      concept: "single-responsibility-fns",
      ...
      correctIndex: 3,
      explanation: "Las god-tools rompen least privilege y la recuperación parcial.",
    },
    {
      concept: "single-responsibility-fns",
      question: "Nombrar tools por verbo+recurso (get_case, file_ticket) ayuda a:",
      options: [
        "Políticas y logs auditables por acción",
        "Confundir al planner",
        "Ocultar side effects",
        "Evitar JSON schema",
      ],
      correctIndex: 0,
      explanation: "Nombres claros habilitan políticas y auditoría por acción.",
    },
    {
      ...
      correctIndex: 1,
      explanation: "El schema valida y rechaza argumentos inválidos antes de ejecutar.",
    },
    {
      concept: "schema-perms-idempotency-errors",
      ...
      correctIndex: 2,
      explanation: "Los permisos por tool habilitan least privilege en runtime.",
    },
    {
      concept: "schema-perms-idempotency-errors",
      ...
      correctIndex: 3,
      explanation: "La idempotency key evita efectos duplicados en retries.",
    },
    {
      ...
      correctIndex: 0,
      explanation: "Contexto mínimo: solo lo necesario, justo a tiempo (JIT).",
    },
    {
      concept: "min-context-jit-checkpoints",
      ...
      options: [
        ...
        "Reanudar y auditar la trayectoria",
        "Evitar presupuestos",
        "Desactivar human approval",
      ],
      correctIndex: 1,
      explanation: "El checkpoint permite reanudar y auditar sin volver a ejecutar side effects.",
    },
    {
      concept: "min-context-jit-checkpoints",
      question: "JIT retrieval de docs frente a un prompt estático enorme:",
      options: [
        "Siempre es peor",
        "Impide citas",
      ...
      correctIndex: 2,
      explanation: "JIT reduce tokens y trae evidencia actualizada solo cuando hace falta.",
    },
    {
      ...
      correctIndex: 3,
      explanation: "Compaction acota el historial; debe conservar hechos críticos o restaurar LKG.",
    },
    {
      concept: "memory-compaction-lkg",
      question: "Last-known-good (LKG) se usa para:",
      options: [
      ...
      correctIndex: 0,
      explanation: "LKG es el checkpoint seguro de recovery.",
    },
    {
      concept: "memory-compaction-lkg",
      ...
      options: [
        ...
        "PII real sin base legal",
        "Escritura sin schema",
      ],
      correctIndex: 1,
      explanation: "La memoria del agente sigue gobernanza de datos: ACL, propósito y minimización.",
    },
    {
      ...
      options: [
        ...
        "Alcanza límites de costo, latencia o seguridad definidos",
        "El usuario parpadea",
      ],
      correctIndex: 2,
      explanation: "Budgets enforcean stop con razón explícita (p. ej. STOP_BUDGET_EXHAUSTED).",
    },
    {
      concept: "stopping-budgets",
      ...
      options: [
        ...
        "Firmar releases",
        "Entrar en un loop de tools quemando costo",
      ],
      correctIndex: 3,
      explanation: "Sin stop, el loop de tools puede quemar presupuesto sin fin.",
    },
    {
      concept: "stopping-budgets",
      question: "Las stop conditions deben ser:",
      options: [
      ...
      correctIndex: 0,
      explanation: "Las paradas se enforcean en runtime, no solo en el texto del prompt.",
    },
    {
      ...
      correctIndex: 1,
      explanation: "El sandbox contiene el daño cuando el agente se equivoca.",
    },
    {
      concept: "sandbox-human-approval-recovery",
      ...
      correctIndex: 2,
      explanation: "HITL para acciones irreversibles o de alto impacto, ligada a la tool/llamada.",
    },
    {
      concept: "sandbox-human-approval-recovery",
      ...
      options: [
        ...
        "Clasificar el error, reintentar con política o escalar/compensar",
      ],
      correctIndex: 3,
      explanation: "Recovery estructurado: clasificar, política de retry o escalamiento — sin efectos duplicados.",
    },
  ],
...
async function main() {
  ...
  console.log('\n✅ Seed complete!')
  console.log('   No users or credentials were created. Provision operators out of band.')
}
